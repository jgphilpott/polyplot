...
function drawGraph(svg, windowWidth, windowHeight, topMargin, rightMargin, bottomMargin, leftMargin, xAxisScale, yAxisScale, xAxisLabel, yAxisLabel, graphWidth, graphHeight) {
  ...
  svg.append("line")
     ...
     .attr("x1", leftMargin + 150)
     .attr("y1", 80)
     .attr("x2", (leftMargin + graphWidth) - 150)
     .attr("y2", 80)
...
//////////////////
  ...
  svg.append("path")
     ...
     .attr("fill", "grey")
     .attr("stroke-width", 1)
     .attr("transform", "translate(" + (leftMargin + 53) + ", 63.5)")
  ...
  svg.append("path")
     ...
     .attr("fill", "grey")
     .attr("stroke-width", 1)
     .attr("transform", "translate(" + (leftMargin + 10) + ", 63.5)")
  ...
  svg.append("path")
     ...
     .attr("fill", "grey")
     .attr("stroke-width", 1)
     .attr("transform", "translate(" + (leftMargin + 96) + ", 63.5)")
...
//////////////////
  ...
  svg.append("path")
     ...
     .attr("fill", "grey")
     .attr("stroke-width", 1)
     .attr("transform", "translate(" + (leftMargin + graphWidth - 86) + ", 63.5)")
  ...
  svg.append("path")
     ...
     .attr("fill", "grey")
     .attr("stroke-width", 1)
     .attr("transform", "translate(" + (leftMargin + graphWidth - 43) + ", 63.5)")
  ...
  svg.append("path")
     ...
     .attr("fill", "grey")
     .attr("stroke-width", 1)
     .attr("transform", "translate(" + (leftMargin + graphWidth - 129) + ", 63.5)")
...
svg.append("circle")
      .attr("cx", (leftMargin + graphWidth/2 + 11))
      .attr("cy", 80)
      .attr("r", 14)
      .attr("fill", "white")

svg.append("circle")
      .attr("cx", (leftMargin + 155 + 11))
      .attr("cy", 80)
      .attr("r", 14)
      .attr("fill", "white")

svg.append("circle")
      .attr("cx", (leftMargin + graphWidth - 11 - 155))
      .attr("cy", 80)
      .attr("r", 14)
      .attr("fill", "white")
...
//////////////////////
  ...
  svg.append("path")
     ...
     .attr("fill", "grey")
     .attr("stroke-width", 1)
     .attr("transform", "translate(" + (leftMargin + 155) + ", 68.5)")
  ...
  svg.append("path")
     ...
     .attr("fill", "grey")
     .attr("stroke-width", 1)
     .attr("transform", "translate(" + (leftMargin + graphWidth - 177) + ", 68.5)")
     .attr("d", "M11.2 0c-6.186 0-11.2 5.014-11.2 11.2s5.014 11.2 11.2 11.2 11.2-5.014 11.2-11.2-5.014-11.2-11.2-11.2zM11.2 19.6c-4.639 0-8.4-3.761-8.4-8.4s3.761-8.4 8.4-8.4c4.639 0 8.4 3.761 8.4 8.4s-3.761 8.4-8.4 8.4zM7 11.2c0-2.32 1.88-4.2 4.2-4.2s4.2 1.88 4.2 4.2c0 2.32-1.88 4.2-4.2 4.2s-4.2-1.88-4.2-4.2z");
  ...
  svg.append("path")
     ...
     .attr("fill", "grey")
     .attr("stroke-width", 1)
     .attr("transform", "translate(" + (leftMargin + graphWidth/2) + ", 68.5)")
